...
fun Int.aboveVersion() = Build.VERSION.SDK_INT > this

fun Int.onMinVersion() = Build.VERSION.SDK_INT >= this
...
fun Context.getAppVersionCode(): Long =
    if (Build.VERSION_CODES.P.onMinVersion()) getLongAppVersion() else getAppIntVersion().toLong()
